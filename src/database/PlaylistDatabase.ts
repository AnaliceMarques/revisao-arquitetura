...
export class PlaylistDatabase extends BaseDatabase {
  ...
  > => {
    ...
    return result as PlaylistDBWhitCreatorName[];
  };
  ...
  public deletePlaylist = async (id: string): Promise<void> => {
    await BaseDatabase.connection(PlaylistDatabase.TABLE_PLAYLISTS)
      .delete()
      .where({ id });
  };
  ...
  public findPlaylistWithCreatorNameById = async (
    id: string
  ): Promise<PlaylistDBWhitCreatorName | undefined> => {
    const [result] = await BaseDatabase.connection(
      PlaylistDatabase.TABLE_PLAYLISTS
    )
      .select(
    ...
    return result as PlaylistDBWhitCreatorName | undefined;
  };
